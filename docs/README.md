...
- [`architecture/`](./architecture/) — the architecture specification. One
  markdown file per section / appendix; equations are preserved as LaTeX
  rendered with MathJax (see `mkdocs.yml`).
